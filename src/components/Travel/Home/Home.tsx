...
import { BusSchedule, Location, Route, TravelRoute, getBusScheduleTableData, getLocationTableData, getRouteTableData } from '@app/api/main/route.api';
...
export interface IsearchData { from: number, to: number }
